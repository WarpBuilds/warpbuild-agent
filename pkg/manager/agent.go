...
type AgentOptions struct {
	...
	// TelemetryPort is where the telemetryd sibling process listens — the
	// same receiver port the collector exports into. Used to ask it to
	// flush before this VM is reaped.
