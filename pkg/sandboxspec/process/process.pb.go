...
type StartRequest struct {
	...
	Tag     *string                `protobuf:"bytes,3,opt,name=tag,proto3,oneof" json:"tag,omitempty"`
	// Unset means true. Do not change this default: older clients omit the
	// field and expect a stdin pipe to exist.
...
// PTY output arrives on `pty`, never on stdout or stderr.
...
const file_process_process_proto_rawDesc = "" +
	...
	"\n" +
	"CloseStdin\x12\x1a.process.CloseStdinRequest\x1a\x1b.process.CloseStdinResponseB?Z=github.com/warpbuilds/warpbuild-agent/pkg/sandboxspec/processb\x06proto3"
